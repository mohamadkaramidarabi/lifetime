...
class AutoCompleteCountryAdapter constructor(private val mContext: Context, @LayoutRes private val viewResourceId: Int, items: ArrayList<String>) : ArrayAdapter<String>(mContext, viewResourceId, items) {
